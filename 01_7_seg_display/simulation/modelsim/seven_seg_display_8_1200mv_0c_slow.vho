...
-- RSTin	=>  Location: PIN_6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- CLKin	=>  Location: PIN_223,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF seven_seg_display IS
...
SIGNAL \RSTin~input_o\ : std_logic;
...
-- Equation(s):
-- \count~3_combout\ = (\Add0~14_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~1_combout\ = (\Add0~26_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~0_combout\ = (!\Equal0~8_combout\ & \Add0~28_combout\)
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(8) & (!count(7) & (!count(10) & !count(9))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(14) & (count(13) & (!count(11) & count(12))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(2) & (count(15) & (count(0) & count(1))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(6) & (count(4) & (count(3) & count(5))))
...
\RSTin~input\ : cycloneiii_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")

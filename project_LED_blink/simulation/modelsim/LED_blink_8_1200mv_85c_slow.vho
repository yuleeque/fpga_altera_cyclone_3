...
-- Equation(s):
-- \Equal0~5_combout\ = (count(17) & (!count(18) & (count(19) & !count(16))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (count(22) & (count(21) & (count(23) & count(20))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(15) & (count(14) & (count(1) & count(0))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(13) & (!count(10) & (count(12) & !count(11))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(4) & (count(2) & (count(3) & count(5))))
